<?php
/**
 * Template Name: Single Category Newsletter
 */
...
?>
	...
	<div class="content-wrapper <?php echo $sidebar_class; ?>">
		...
		<div class="four columns mt0 gdl-right-sidebar">
					<div class="right-sidebar-wrapper gdl-divider" style="height: 906px;">
					<h3 class="custom-sidebar-title sidebar-title-color gdl-title">Newsletter Archive</h3>
						<ul id="category-sidebar-list">
						 <?php
						 global $post;
						 $myposts = get_posts('numberposts=25&offset=1&category=50&orderby=post_date');
						 foreach($myposts as $post) :
						 ?>
						    <li><a href="<?php the_permalink(); ?>"><?php the_time('F j, Y'); ?></a></li>
						 <?php endforeach; ?>
 </ul>
					</div>
		</div>
