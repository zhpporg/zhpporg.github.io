<?php
	...
	*/
	...
	// custom template for newsletter posts
...
function aside_shortcode( $atts, $content = null ) {
   return '<p class="aside">' . $content . '</p>';
}
...
function requirements_shortcode( $atts, $content = null ) {
   return '<p class="requirements">' . $content . '</p>';
}
add_shortcode( 'requirements', 'requirements_shortcode' );
